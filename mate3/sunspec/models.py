...
class OutBackModel(Model):
    ...
    def __init__(self):
        ...
        self.enable_dhcp: EnumUint16Field = EnumUint16Field("enable_dhcp", 22, 1, Mode.RW, options=Enum("enable_dhcp", [('DHCP Disabled, use configured network parameter', 0), ('DHCP Enabled', 1)]), description="0 = DHCP Disabled, use configured network parameter; 1 = DHCP Enabled")
        ...
        self.smtp_ssl_enable: EnumUint16Field = EnumUint16Field("smtp_ssl_enable", 70, 1, Mode.RW, options=Enum("smtp_ssl_enable", [('SSL Disabled', 0), ('SSL Enabled (not implemented)', 1)]), description="0 = SSL Disabled; 1 = SSL Enabled (not implemented)")
        ...
        self.alarm_email_enable: EnumUint16Field = EnumUint16Field("alarm_email_enable", 166, 1, Mode.RW, options=Enum("alarm_email_enable", [('Disabled', 0), ('Enabled', 1)]), description="0 = Disabled; 1 = Enabled")
        ...
        self.sd_card_data_logging_mode: EnumUint16Field = EnumUint16Field("sd_card_data_logging_mode", 250, 1, Mode.RW, options=Enum("sd_card_data_logging_mode", [('Compact Format', 2), ('Disabled', 0), ('Excel Format', 1)]), description="0 = Disabled; 1 = Excel Format; 2 = Compact Format")
        self.time_server_name: StringField = StringField("time_server_name", 251, 20, Mode.RW, description="Timeserver domain name")
        self.enable_time_server: EnumUint16Field = EnumUint16Field("enable_time_server", 271, 1, Mode.RW, options=Enum("enable_time_server", [('Time  Server Enabled', 1), ('Time Server Disabled, use configured time parameters', 0)]), description="0 = Time Server Disabled, use configured time parameters; 1 = Time  Server Enabled")
        self.enable_float_coordination: EnumUint16Field = EnumUint16Field("enable_float_coordination", 273, 1, Mode.RW, options=Enum("enable_float_coordination", [('Disabled', 0), ('Enabled', 1)]), description="0=Disabled, 1=Enabled")
        self.enable_fndc_charge_termination: EnumUint16Field = EnumUint16Field("enable_fndc_charge_termination", 274, 1, Mode.RW, options=Enum("enable_fndc_charge_termination", [('Disabled', 0), ('Enabled', 1)]), description="0=Disabled, 1=Enabled")
        self.enable_fndc_grid_tie_control: EnumUint16Field = EnumUint16Field("enable_fndc_grid_tie_control", 275, 1, Mode.RW, options=Enum("enable_fndc_grid_tie_control", [('Disabled', 0), ('Enabled', 1)]), description="0=Disabled, 1=Enabled")
        ...
        self.ags_mode: EnumUint16Field = EnumUint16Field("ags_mode", 278, 1, Mode.RW, options=Enum("ags_mode", [('Disabled', 0), ('Enabled', 1)]), description="0=Disabled, 1=Enabled")
        self.ags_port: Uint16Field = Uint16Field("ags_port", 279, 1, Mode.RW, description="AGS device port number 0-10")
        self.ags_port_type: EnumUint16Field = EnumUint16Field("ags_port_type", 280, 1, Mode.RW, options=Enum("ags_port_type", [('Radian AUX Output', 1), ('Radian AUX Relay', 0)]), description="0=Radian AUX Relay, 1=Radian AUX Output")
        self.ags_generator_type: EnumUint16Field = EnumUint16Field("ags_generator_type", 281, 1, Mode.RW, options=Enum("ags_generator_type", [('AC Gen', 0), ('DC Gen', 1), ('No Gen', 2)]), description="0=AC Gen, 1=DC Gen, 2=No Gen")
        ...
        self.ags_generator_exercise_mode: EnumUint16Field = EnumUint16Field("ags_generator_exercise_mode", 287, 1, Mode.RW, options=Enum("ags_generator_exercise_mode", [('Disabled', 0), ('Enabled', 1)]), description="0=Disabled, 1=Enabled")
        ...
        self.ags_exercise_day: EnumUint16Field = EnumUint16Field("ags_exercise_day", 290, 1, Mode.RW, options=Enum("ags_exercise_day", [('Fri', 5), ('Mon', 1), ('Sat', 6), ('Sun', 0), ('Thr', 4), ('Tue', 2), ('Wed', 3)]), description="0=Sun, 1=Mon, 2=Tue, 3=Wed, 4=Thr, 5=Fri, 6=Sat")
        ...
        self.ags_sell_mode: EnumUint16Field = EnumUint16Field("ags_sell_mode", 293, 1, Mode.RW, options=Enum("ags_sell_mode", [('Selling Disabled', 1), ('Selling Enabled', 0)]), description="Sell During Generator Exercise Period, 0=Selling Enabled, 1=Selling Disabled")
        self.ags_2_min_start_mode: EnumUint16Field = EnumUint16Field("ags_2_min_start_mode", 294, 1, Mode.RW, options=Enum("ags_2_min_start_mode", [('Disabled', 0), ('Enabled', 1)]), description="0=Disabled, 1=Enabled")
        self.ags_2_hour_start_mode: EnumUint16Field = EnumUint16Field("ags_2_hour_start_mode", 296, 1, Mode.RW, options=Enum("ags_2_hour_start_mode", [('Disabled', 0), ('Enabled', 1)]), description="0=Disabled, 1=Enabled")
        self.ags_24_hour_start_mode: EnumUint16Field = EnumUint16Field("ags_24_hour_start_mode", 298, 1, Mode.RW, options=Enum("ags_24_hour_start_mode", [('Disabled', 0), ('Enabled', 1)]), description="0=Disabled, 1=Enabled")
        self.ags_load_start_mode: EnumUint16Field = EnumUint16Field("ags_load_start_mode", 300, 1, Mode.RW, options=Enum("ags_load_start_mode", [('Disabled', 0), ('Enabled', 1)]), description="0=Disabled, 1=Enabled")
        ...
        self.ags_soc_start_mode: EnumUint16Field = EnumUint16Field("ags_soc_start_mode", 305, 1, Mode.RW, options=Enum("ags_soc_start_mode", [('Disabled', 0), ('Enabled', 1)]), description="0=Disabled, 1=Enabled")
        ...
        self.ags_enable_full_charge_mode: EnumUint16Field = EnumUint16Field("ags_enable_full_charge_mode", 308, 1, Mode.RW, options=Enum("ags_enable_full_charge_mode", [('Disabled', 0), ('Enabled', 1)]), description="0=Disabled, 1=Enabled")
        ...
        self.ags_must_run_mode: EnumUint16Field = EnumUint16Field("ags_must_run_mode", 310, 1, Mode.RW, options=Enum("ags_must_run_mode", [('Disabled', 0), ('Enabled', 1)]), description="0=Disabled, 1=Enabled")
        ...
        self.ags_quiet_time_mode: EnumUint16Field = EnumUint16Field("ags_quiet_time_mode", 319, 1, Mode.RW, options=Enum("ags_quiet_time_mode", [('Disabled', 0), ('Enabled', 1)]), description="0=Disabled, 1=Enabled")
        ...
        self.hbx_mode: EnumUint16Field = EnumUint16Field("hbx_mode", 330, 1, Mode.RW, options=Enum("hbx_mode", [('Both', 3), ('Disabled', 0), ('SOC Only', 2), ('Voltage Only', 1)]), description="0=Disabled, 1=Voltage Only, 2=SOC Only, 3=Both")
        ...
        self.grid_use_interval_1_mode: EnumUint16Field = EnumUint16Field("grid_use_interval_1_mode", 337, 1, Mode.RW, options=Enum("grid_use_interval_1_mode", [('Disabled', 0), ('Enabled', 1)]), description="0=Disabled, 1=Enabled")
        ...
        self.grid_use_interval_2_mode: EnumUint16Field = EnumUint16Field("grid_use_interval_2_mode", 346, 1, Mode.RW, options=Enum("grid_use_interval_2_mode", [('Disabled', 0), ('Enabled', 1)]), description="0=Disabled, 1=Enabled")
        ...
        self.grid_use_interval_3_mode: EnumUint16Field = EnumUint16Field("grid_use_interval_3_mode", 351, 1, Mode.RW, options=Enum("grid_use_interval_3_mode", [('Disabled', 0), ('Enabled', 1)]), description="0=Disabled, 1=Enabled")
        ...
        self.load_grid_transfer_mode: EnumUint16Field = EnumUint16Field("load_grid_transfer_mode", 356, 1, Mode.RW, options=Enum("load_grid_transfer_mode", [('Disabled', 0), ('Enabled', 1)]), description="0=Disabled, 1=Enabled")
        ...
        self.global_charger_control_mode: EnumUint16Field = EnumUint16Field("global_charger_control_mode", 362, 1, Mode.RW, options=Enum("global_charger_control_mode", [('Disabled', 0), ('Enabled', 1)]), description="0=Disabled, 1=Enabled")
        ...
        self.radian_ac_coupled_control_mode: EnumUint16Field = EnumUint16Field("radian_ac_coupled_control_mode", 364, 1, Mode.RW, options=Enum("radian_ac_coupled_control_mode", [('Disabled', 0), ('Enabled', 1)]), description="0=Disabled, 1=Enabled")
        ...
        self.web_user_logged_in_status: EnumUint16Field = EnumUint16Field("web_user_logged_in_status", 388, 1, Mode.RW, options=Enum("web_user_logged_in_status", [('WEB User NOT logged in', 0), ('WEB user logged in', 1)]), description="0=WEB User NOT logged in, 1=WEB user logged in")
        self.hub_type: EnumUint16Field = EnumUint16Field("hub_type", 389, 1, Mode.R, options=Enum("hub_type", [('HUB10.3', 10), ('HUB3PH', 11), ('HUB4', 4), ('Legecy HUB', 0)]), description="0=Legecy HUB, 4= HUB4, 10=HUB10.3, 11=HUB3PH")
        ...
        self.gateway_type: EnumUint16Field = EnumUint16Field("gateway_type", 405, 1, Mode.R, options=Enum("gateway_type", [('AXS Port', 1), ('MATE3', 2)]), description="1=AXS Port, 2= MATE3")
        ...
        self.multi_phase_coordination: EnumUint16Field = EnumUint16Field("multi_phase_coordination", 409, 1, Mode.RW, options=Enum("multi_phase_coordination", [('Disabled', 0), ('Enabled', 1)]), description="0=Disabled, 1=Enabled")
        ...
        self.auto_reboot: EnumUint16Field = EnumUint16Field("auto_reboot", 419, 1, Mode.RW, options=Enum("auto_reboot", [('Disable', 0), ('Enable', 1)]), description="OPTICS auto reboot every 24 hours 0=Disable, 1=Enable")
...
class ChargeControllerModel(Model):
    ...
    def __init__(self):
        ...
        self.charger_state: EnumUint16Field = EnumUint16Field("charger_state", 13, 1, Mode.R, options=Enum("charger_state", [('Absorb', 3), ('Bulk', 2), ('EQ', 4), ('Float', 1), ('Silent', 0)]), description="0 = Silent; 1 = Float; 2 = Bulk; 3 = Absorb; 4 = EQ")
...
class ChargeControllerConfigurationModel(Model):
    ...
    def __init__(self):
        ...
        self.mppt_mode: EnumUint16Field = EnumUint16Field("mppt_mode", 20, 1, Mode.RW, options=Enum("mppt_mode", [('Auto', 0), ('U-Pick', 1)]), description="0 = Auto; 1 = U-Pick")
        self.sweep_width: EnumUint16Field = EnumUint16Field("sweep_width", 21, 1, Mode.RW, options=Enum("sweep_width", [('Full', 0), ('Half', 1)]), description="0 = Full; 1 = Half")
        self.sweep_max_percentage: EnumUint16Field = EnumUint16Field("sweep_max_percentage", 22, 1, Mode.RW, options=Enum("sweep_max_percentage", [('80', 0), ('85', 1), ('90', 2), ('99', 3)]), description="0 = 80; 1 = 85; 2 = 90; 3 = 99")
        self.grid_tie_mode: EnumUint16Field = EnumUint16Field("grid_tie_mode", 24, 1, Mode.RW, options=Enum("grid_tie_mode", [('Grid Tie Mode disabled', 0), ('Grid Tie Mode enabled', 1)]), description="0 = Grid Tie Mode disabled; 1 = Grid Tie Mode enabled")
        self.temp_comp_mode: EnumUint16Field = EnumUint16Field("temp_comp_mode", 25, 1, Mode.RW, options=Enum("temp_comp_mode", [('User Limited', 1), ('Wide', 0)]), description="0 = Wide; 1 = User Limited")
        ...
        self.auto_restart_mode: EnumUint16Field = EnumUint16Field("auto_restart_mode", 29, 1, Mode.RW, options=Enum("auto_restart_mode", [('Off', 0), ('Restart every 90 minutes', 1), ('Restart every 90 minutes if absorb charging or float charging', 2)]), description="0 = Off; 1 = Restart every 90 minutes; 2 = Restart every 90 minutes if absorb charging or float charging")
        ...
        self.aux_control: EnumUint16Field = EnumUint16Field("aux_control", 34, 1, Mode.RW, options=Enum("aux_control", [('Auto', 1), ('Off', 0), ('On', 2)]), description="0 = Off; 1 = Auto; 2 = On")
        self.aux_state: EnumUint16Field = EnumUint16Field("aux_state", 35, 1, Mode.R, options=Enum("aux_state", [('Disabled', 0), ('Enabled', 1)]), description="0 = Disabled; 1 = Enabled")
        self.aux_polarity: EnumUint16Field = EnumUint16Field("aux_polarity", 36, 1, Mode.RW, options=Enum("aux_polarity", [('High', 1), ('Low', 0)]), description="0 = Low; 1 = High")
...
class FXInverterRealTimeModel(Model):
    ...
    def __init__(self):
        ...
        self.inverter_operating_mode: EnumUint16Field = EnumUint16Field("inverter_operating_mode", 13, 1, Mode.R, options=Enum("inverter_operating_mode", [('Charger Off', 7), ('Charging', 3), ('EQ', 6), ('Float', 5), ('Inverting', 2), ('Off', 0), ('Offsetting', 14), ('Pass through', 10), ('Searching', 1), ('Selling', 9), ('Silent', 4), ('Support', 8)]), description="0=Off, 1=Searching, 2=Inverting, 3=Charging, 4=Silent, 5=Float, 6=EQ, 7=Charger Off, 8=Support, 9=Selling, 10=Pass through, 14=Offsetting")
        ...
        self.aux_output_state: EnumUint16Field = EnumUint16Field("aux_output_state", 18, 1, Mode.R, options=Enum("aux_output_state", [('Disabled', 0), ('Enabled', 1)]), description="0 = Disabled; 1 = Enabled")
        ...
        self.ac_input_state: EnumUint16Field = EnumUint16Field("ac_input_state", 24, 1, Mode.R, options=Enum("ac_input_state", [('AC Use', 1), ('AC_Drop', 0)]), description="1=AC Use, 0=AC_Drop")
...
class FXInverterConfigurationModel(Model):
    ...
    def __init__(self):
        ...
        self.ac_input_type: EnumUint16Field = EnumUint16Field("ac_input_type", 21, 1, Mode.RW, options=Enum("ac_input_type", [('Gen', 1), ('Grid', 0), ('Grid Zero', 2)]), description="0=Grid, 1=Gen, 2=Grid Zero")
        self.input_support: EnumUint16Field = EnumUint16Field("input_support", 22, 1, Mode.RW, options=Enum("input_support", [('No (only valid if AC Input Type is Gen)', 0), ('Yes', 1)]), description="1=Yes, 0=No (only valid if AC Input Type is Gen)")
        self.charger_operating_mode: EnumUint16Field = EnumUint16Field("charger_operating_mode", 26, 1, Mode.RW, options=Enum("charger_operating_mode", [('Charger Auto', 1), ('Charger Off', 0), ('Charger On', 2)]), description="0=Charger Off, 1=Charger Auto, 2=Charger On")
        ...
        self.aux_mode: EnumUint16Field = EnumUint16Field("aux_mode", 37, 1, Mode.RW, options=Enum("aux_mode", [('AC Drop', 8), ('Cool Fan', 5), ('Divert AC', 7), ('Divert DC', 6), ('Fault', 3), ('Gen Alert', 2), ('Load Shed', 1), ('Remote', 0), ('Vent Fan', 4)]), description="0=Remote, 1=Load Shed, 2=Gen Alert, 3=Fault, 4=Vent Fan, 5=Cool Fan, 6=Divert DC, 7=Divert AC, 8=AC Drop")
        self.aux_control: EnumUint16Field = EnumUint16Field("aux_control", 38, 1, Mode.RW, options=Enum("aux_control", [('Auto', 1), ('Off', 0), ('On', 2)]), description="0 = Off; 1 = Auto; 2 = On")
        ...
        self.grid_tie_window: EnumUint16Field = EnumUint16Field("grid_tie_window", 52, 1, Mode.RW, options=Enum("grid_tie_window", [('IEEE', 0), ('User', 1)]), description="0=IEEE, 1=User")
        self.grid_tie_enable: EnumUint16Field = EnumUint16Field("grid_tie_enable", 53, 1, Mode.RW, options=Enum("grid_tie_enable", [('No', 0), ('Yes', 1)]), description="1=Yes, 0=No")
...
class SplitPhaseRadianInverterRealTimeModel(Model):
    ...
    def __init__(self):
        ...
        self.aux_output_state: EnumInt16Field = EnumInt16Field("aux_output_state", 27, 1, Mode.R, options=Enum("aux_output_state", [('Disabled', 0), ('Enabled', 1)]), description="0 = Disabled; 1 = Enabled")
        self.aux_relay_output_state: EnumInt16Field = EnumInt16Field("aux_relay_output_state", 28, 1, Mode.R, options=Enum("aux_relay_output_state", [('Disabled', 0), ('Enabled', 1)]), description="0 = Disabled; 1 = Enabled")
        ...
        self.ac_input_selection: EnumInt16Field = EnumInt16Field("ac_input_selection", 36, 1, Mode.R, options=Enum("ac_input_selection", [('Gen', 1), ('Grid', 0)]), description="0=Grid, 1=Gen")
        self.ac_input_state: EnumInt16Field = EnumInt16Field("ac_input_state", 39, 1, Mode.R, options=Enum("ac_input_state", [('AC Use', 1), ('AC_Drop', 0)]), description="1=AC Use, 0=AC_Drop")
...
class RadianInverterConfigurationModel(Model):
    ...
    def __init__(self):
        ...
        self.search_pulse_length: Uint16Field = Uint16Field("search_pulse_length", 19, 1, Mode.RW, units="Cycles", description="Search pulse length")
        self.search_pulse_spacing: Uint16Field = Uint16Field("search_pulse_spacing", 20, 1, Mode.RW, units="Cycles", description="Search pulse spacing")
        self.ac_input_select_priority: EnumUint16Field = EnumUint16Field("ac_input_select_priority", 21, 1, Mode.RW, options=Enum("ac_input_select_priority", [('Gen', 1), ('Grid', 0)]), description="0=Grid, 1=Gen")
        self.charger_operating_mode: EnumUint16Field = EnumUint16Field("charger_operating_mode", 25, 1, Mode.RW, options=Enum("charger_operating_mode", [('All Inverter Charging Disabled', 0), ('Bulk and Float Charging Enabled', 1)]), description="0=All Inverter Charging Disabled, 1=Bulk and Float Charging Enabled")
        self.ac_coupled: EnumUint16Field = EnumUint16Field("ac_coupled", 26, 1, Mode.R, options=Enum("ac_coupled", [('No', 0), ('Yes', 1)]), description="0=No, 1=Yes")
        self.grid_input_mode: EnumUint16Field = EnumUint16Field("grid_input_mode", 27, 1, Mode.RW, options=Enum("grid_input_mode", [('Backup', 4), ('Generator', 0), ('Grid Tied', 2), ('Grid Zero', 6), ('Mini Grid', 5), ('Support', 1), ('UPS', 3)]), description="Grid Input Mode: 0=Generator, 1=Support, 2=Grid Tied, 3=UPS, 4=Backup, 5=Mini Grid, 6=Grid Zero")
        ...
        self.gen_input_mode: EnumUint16Field = EnumUint16Field("gen_input_mode", 32, 1, Mode.RW, options=Enum("gen_input_mode", [('Backup', 4), ('Generator', 0), ('Grid Tied', 2), ('Grid Zero', 6), ('Mini Grid', 5), ('Support', 1), ('UPS', 3)]), description="Grid Input Mode: 0=Generator, 1=Support, 2=Grid Tied, 3=UPS, 4=Backup, 5=Mini Grid, 6=Grid Zero")
        ...
        self.aux_control: EnumUint16Field = EnumUint16Field("aux_control", 41, 1, Mode.RW, options=Enum("aux_control", [('Auto', 1), ('Off', 0), ('On', 2)]), description="0 = Off; 1 = Auto; 2 = On")
        self.aux_relay_mode: EnumUint16Field = EnumUint16Field("aux_relay_mode", 46, 1, Mode.RW, options=Enum("aux_relay_mode", [('AC Divert', 9), ('AC Source Status', 8), ('Cool Fan', 5), ('DC Divert', 6), ('Fault', 3), ('Gen Alert', 2), ('Grid Limit/IEEE', 7), ('Load Shed', 1), ('Vent Fan', 4)]), description="1=Load Shed, 2=Gen Alert, 3=Fault, 4=Vent Fan, 5=Cool Fan, 6=DC Divert, 7=Grid Limit/IEEE ,8=AC Source Status,9=AC Divert")
        self.aux_relay_control: EnumUint16Field = EnumUint16Field("aux_relay_control", 47, 1, Mode.RW, options=Enum("aux_relay_control", [('Auto', 2), ('Off', 0), ('On', 1)]), description="0 = Off; 1 = On; 2 = Auto")
        self.stacking_mode: EnumUint16Field = EnumUint16Field("stacking_mode", 52, 1, Mode.RW, options=Enum("stacking_mode", [('B Phase Master', 17), ('C Phase Master', 18), ('Master', 10), ('Slave', 12)]), description="10=Master, 12=Slave, 17=B Phase Master, 18=C Phase Master")
        ...
        self.grid_tie_window: EnumUint16Field = EnumUint16Field("grid_tie_window", 56, 1, Mode.RW, options=Enum("grid_tie_window", [('IEEE', 0), ('User (GS8048 Only)', 1)]), description="0=IEEE, 1=User (GS8048 Only)")
        self.grid_tie_enable: EnumUint16Field = EnumUint16Field("grid_tie_enable", 57, 1, Mode.RW, options=Enum("grid_tie_enable", [('No', 0), ('Yes', 1)]), description="1=Yes, 0=No")
        ...
        self.module_control: EnumUint16Field = EnumUint16Field("module_control", 85, 1, Mode.RW, options=Enum("module_control", [('Auto', 0), ('Both', 3), ('Left', 1), ('Right', 2)]), description="0=Auto, 1=Left, 2=Right, 3=Both")
        self.model_select: EnumUint16Field = EnumUint16Field("model_select", 86, 1, Mode.RW, options=Enum("model_select", [('Full', 0), ('Half', 1)]), description="0=Full, 1=Half")
        self.ee_write_enable: EnumUint16Field = EnumUint16Field("ee_write_enable", 91, 1, Mode.RW, options=Enum("ee_write_enable", [('Disable', 0), ('Enable', 1)]), description="EEPROM Write Enable 1= Enable, 0= Disable")
        self.absorb_volts: FloatUint16Field = FloatUint16Field("absorb_volts", 11, 1, Mode.RW, units="DC Volts", scale_factor=self.dc_voltage_scale_factor, description="Absorb Voltage Target")
        self.absorb_time_hours: FloatUint16Field = FloatUint16Field("absorb_time_hours", 12, 1, Mode.RW, units="Hours", scale_factor=self.time_scale_factor, description="Absorb Time Hours")
        self.float_volts: FloatUint16Field = FloatUint16Field("float_volts", 13, 1, Mode.RW, units="DC Volts", scale_factor=self.dc_voltage_scale_factor, description="Float Voltage Target")
        self.float_time_hours: FloatUint16Field = FloatUint16Field("float_time_hours", 14, 1, Mode.RW, units="Hours", scale_factor=self.time_scale_factor, description="Float Time Hours")
...
class SinglePhaseRadianInverterRealTimeModel(Model):
    ...
    def __init__(self):
        ...
        self.aux_output_state: EnumUint16Field = EnumUint16Field("aux_output_state", 20, 1, Mode.R, options=Enum("aux_output_state", [('Disabled', 0), ('Enabled', 1)]), description="0 = Disabled; 1 = Enabled")
        self.aux_relay_output_state: EnumUint16Field = EnumUint16Field("aux_relay_output_state", 21, 1, Mode.R, options=Enum("aux_relay_output_state", [('Disabled', 0), ('Enabled', 1)]), description="0 = Disabled; 1 = Enabled")
        ...
        self.ac_input_selection: EnumUint16Field = EnumUint16Field("ac_input_selection", 29, 1, Mode.R, options=Enum("ac_input_selection", [('Gen', 1), ('Grid', 0)]), description="0=Grid, 1=Gen")
        self.ac_input_state: EnumUint16Field = EnumUint16Field("ac_input_state", 32, 1, Mode.R, options=Enum("ac_input_state", [('AC Use', 1), ('AC_Drop', 0)]), description="1=AC Use, 0=AC_Drop")
...
class FLEXnetDCConfigurationModel(Model):
    ...
    def __init__(self):
        ...
        self.shunt_a_enabled: EnumUint16Field = EnumUint16Field("shunt_a_enabled", 15, 1, Mode.RW, options=Enum("shunt_a_enabled", [('Disabled', 1), ('Enabled', 0)]), description="0=Enabled, 1=Disabled")
        self.shunt_b_enabled: EnumUint16Field = EnumUint16Field("shunt_b_enabled", 16, 1, Mode.RW, options=Enum("shunt_b_enabled", [('Disabled', 1), ('Enabled', 0)]), description="0=Enabled, 1=Disabled")
        self.shunt_c_enabled: EnumUint16Field = EnumUint16Field("shunt_c_enabled", 17, 1, Mode.RW, options=Enum("shunt_c_enabled", [('Disabled', 1), ('Enabled', 0)]), description="0=Enabled, 1=Disabled")
        self.relay_control: EnumUint16Field = EnumUint16Field("relay_control", 18, 1, Mode.RW, options=Enum("relay_control", [('Auto', 1), ('Off', 0), ('On', 2)]), description="0 = Off; 1 = Auto; 2 = On")
        self.relay_invert_logic: EnumUint16Field = EnumUint16Field("relay_invert_logic", 19, 1, Mode.RW, options=Enum("relay_invert_logic", [('Invert Logic', 0), ('Normal', 1)]), description="0=Invert Logic,1=Normal")
...
class OutBackSystemControlModel(Model):
    ...
    def __init__(self):
        ...
        self.bulk_charge_enable_disable: EnumUint16Field = EnumUint16Field("bulk_charge_enable_disable", 6, 1, Mode.W, options=Enum("bulk_charge_enable_disable", [('Start Bulk', 1), ('Start EQ Charge', 3), ('Stop Bulk', 2), ('Stop EQ Charge', 4)]), description="1=Start Bulk, 2=Stop Bulk, 3=Start EQ Charge, 4= Stop EQ Charge")
        self.inverter_ac_drop_use: EnumUint16Field = EnumUint16Field("inverter_ac_drop_use", 7, 1, Mode.W, options=Enum("inverter_ac_drop_use", [('Drop', 2), ('Use', 1)]), description="1=Use, 2=Drop")
        self.set_inverter_mode: EnumUint16Field = EnumUint16Field("set_inverter_mode", 8, 1, Mode.W, options=Enum("set_inverter_mode", [('Off', 1), ('On', 3), ('Search', 2)]), description="1=Off, 2=Search, 3=On")
        self.grid_tie_mode: EnumUint16Field = EnumUint16Field("grid_tie_mode", 9, 1, Mode.W, options=Enum("grid_tie_mode", [('Disable', 2), ('Enable', 1)]), description="1=Enable, 2=Disable")
        self.set_inverter_charger_mode: EnumUint16Field = EnumUint16Field("set_inverter_charger_mode", 10, 1, Mode.W, options=Enum("set_inverter_charger_mode", [('Auto', 2), ('Off', 1), ('On', 3)]), description="1=Off, 2=Auto, 3=On")
        ...
        self.set_ags_op_mode: EnumUint16Field = EnumUint16Field("set_ags_op_mode", 21, 1, Mode.RW, options=Enum("set_ags_op_mode", [('Auto', 2), ('Off', 0), ('On', 1)]), description="AGS Operating Mode: 0=Off, 1=On, 2=Auto")
        self.ags_operational_state: EnumUint16Field = EnumUint16Field("ags_operational_state", 22, 1, Mode.R, options=Enum("ags_operational_state", [(' GEN_AWAITING_AC', 5), (' GEN_COOLDOWN', 4), (' GEN_RUNNING', 2), (' GEN_STARTING', 1), (' GEN_WARMUP', 3), ('GEN_STOP', 0)]), description="GEN_STOP=0, GEN_STARTING=1, GEN_RUNNING=2, GEN_WARMUP=3, GEN_COOLDOWN=4, GEN_AWAITING_AC=5")
